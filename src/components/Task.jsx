...
export default function Task({ name, category, done, onToggle, onTrash, onRename, onCategoryChange }) {
    ...
    <div className={'task ' + (done ? 'done' : '')}>
      ...
      {!editMode ? (
        ...
        <form onSubmit={ev => { ev.preventDefault(); setEditMode(false); }}>
          ...
          <input type="text" value={category} onChange={ev => onCategoryChange(ev.target.value)} />
        </form>
      )}
